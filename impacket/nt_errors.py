...
ERROR_MESSAGES = {
        ...
        0x140005: ("STATUS_ACPI_INVALID_ARGUMENT", "A required argument was not specified."),
        0x140006: ("STATUS_ACPI_FATAL", "A fatal error has occurred."),
        0x140007: ("STATUS_ACPI_INVALID_SUPERNAME", "An invalid SuperName was specified."),
        0x140008: ("STATUS_ACPI_INVALID_ARGTYPE", "An argument with an incorrect type was specified."),
        0x140009: ("STATUS_ACPI_INVALID_OBJTYPE", "An object with an incorrect type was specified."),
        0x14000A: ("STATUS_ACPI_INVALID_TARGETTYPE", "A target with an incorrect type was specified."),
