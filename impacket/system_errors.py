...
ERROR_MESSAGES = {
        ...
        0x00000014: ("ERROR_BAD_UNIT", "The system cannot find the    def __init__(self, api_port, server_address=('127.0.0.1', 1080), handler_class=SocksRequestHandler):vice specified."),
