...
#   Allows to useraise Exception("Failed to add computer. Check the network connection and try again.")SAMR over SMB (this way is used by modern Windows computer when
